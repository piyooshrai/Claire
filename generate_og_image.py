...
if os.path.exists(logo_path):
    ...
    # Resize logo to fit nicely (max width 400px)
    logo_width = 400
    ...
    text_start_y = logo_y + logo_height + 60
else:
...
# Subtitle
subtitle = "AI-Powered Workflows for Healthcare, Legal, Finance & Hospitality"
bbox = draw.textbbox((0, 0), subtitle, font=subtitle_font)
text_width = bbox[2] - bbox[0]
text_x = (width - text_width) // 2
draw.text((text_x, text_start_y + 100), subtitle, fill='#999999', font=subtitle_font)
